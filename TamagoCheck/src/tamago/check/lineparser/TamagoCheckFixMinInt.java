 ...
 *
 */
public class TamagoCheckFixMinInt implements LineParserSpec {

	/**
	 * 
	 */
	public TamagoCheckFixMinInt() {
	...
	public String getDescription() {
		return "fix the min value of default integer of default int builder";
	}
	...
	public void setArgument(int pos, String value) throws LineParserException {
		try {
			Intvar.MININT = Integer.parseInt(value);
		}
		catch(Exception e) {
