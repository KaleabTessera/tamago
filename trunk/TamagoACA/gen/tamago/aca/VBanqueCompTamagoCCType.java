...
*/
public class VBanqueCompTamagoCCType
    implements tamago.ext.tamagocc.TamagoCCType
{
    ...
    // Methods
    public VBanqueCompTamagoCCType ()
    {
    }
    ...
    */
    public String getName(){
        return "VBanqueCompTamagoCCType";
    }
    ...
    */
    ...
    public java.util.Iterator getExtends(){
        ...
        list.add(new VBanqueTamagoCCType());
    ...
    public TamagoCCPercolator[] getAvailablePercolator(){
        TamagoCCPercolator[] renvoie = new TamagoCCPercolator[2];
