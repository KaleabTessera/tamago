...
*/
public class CDepositContainerImpl_exact
    ...
    implements tamago.aca.bank.CDepositContainer
{
    ...
    */
    public CDepositContainerImpl_exact (tamago.aca.bank.CDeposit component)
    {
    ...
    public void check(tamago.ext.aca2.ACA aca) throws tamago.TamagoException{
        ...
        // Postcondition test
        boolean __tamago_var_perco_3 = (tamago_decorated_component.getOpNumber() > 0);
        if(!__tamago_var_perco_3) {
            java.util.ArrayList __tamago_var_perco_2 = new java.util.ArrayList();
            if(!__tamago_var_perco_3) {
                __tamago_var_perco_2.add(new tamago.ext.tamagocc.TamagoCCFailItem("(#opNumber > 0)"));
            }
    ...
    public void register(tamago.ext.aca2.ACA aca) throws tamago.TamagoException{
        ...
        // Environment of Postcondition
        // Postcondition test
        boolean __tamago_var_perco_23 = (tamago_decorated_component.getOpNumber() > 0);
        if(!__tamago_var_perco_23) {
            java.util.ArrayList __tamago_var_perco_22 = new java.util.ArrayList();
            if(!__tamago_var_perco_23) {
                __tamago_var_perco_22.add(new tamago.ext.tamagocc.TamagoCCFailItem("(#opNumber > 0)"));
            }
