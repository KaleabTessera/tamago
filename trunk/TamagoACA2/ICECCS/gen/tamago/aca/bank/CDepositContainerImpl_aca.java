...
*/
public class CDepositContainerImpl_aca
    ...
    implements tamago.aca.bank.CDepositContainer
{
    ...
    */
    public CDepositContainerImpl_aca (tamago.aca.bank.CDeposit component)
    {
    ...
    public void check(tamago.ext.aca2.ACA aca) throws tamago.TamagoException{
        ...
        // Postcondition test
        boolean __tamago_var_perco_59 = (tamago_decorated_component.getOpNumber() > 0);
        if(!__tamago_var_perco_59) {
            java.util.ArrayList __tamago_var_perco_58 = new java.util.ArrayList();
            if(!__tamago_var_perco_59) {
                __tamago_var_perco_58.add(new tamago.ext.tamagocc.TamagoCCFailItem("(#opNumber > 0)"));
            }
            throw new tamago.ext.tamagocc.TamagoCCFailPostcondition(__tamago_var_perco_58);
        }
    ...
    public void init() throws tamago.TamagoException{
        ...
        // Environment of Postcondition
        // Postcondition test
        boolean __tamago_var_perco_71 = (tamago_decorated_component.getOpNumber() < 0);
        if(!__tamago_var_perco_71) {
            java.util.ArrayList __tamago_var_perco_70 = new java.util.ArrayList();
            if(!__tamago_var_perco_71) {
                __tamago_var_perco_70.add(new tamago.ext.tamagocc.TamagoCCFailItem("(#opNumber < 0)"));
            }
            throw new tamago.ext.tamagocc.TamagoCCFailPostcondition(__tamago_var_perco_70);
        }
        // Invariant test after postcondition
        // Update behavioral's state
    ...
    public void register(tamago.ext.aca2.ACA aca) throws tamago.TamagoException{
        ...
        // Environment of Postcondition
        // Postcondition test
        boolean __tamago_var_perco_79 = (tamago_decorated_component.getOpNumber() > 0);
        if(!__tamago_var_perco_79) {
            java.util.ArrayList __tamago_var_perco_78 = new java.util.ArrayList();
            if(!__tamago_var_perco_79) {
                __tamago_var_perco_78.add(new tamago.ext.tamagocc.TamagoCCFailItem("(#opNumber > 0)"));
            }
            throw new tamago.ext.tamagocc.TamagoCCFailPostcondition(__tamago_var_perco_78);
        }
        // Invariant test after postcondition
        // Update behavioral's state
