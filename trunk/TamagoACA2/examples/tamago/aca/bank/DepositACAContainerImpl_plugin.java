    ...
    implements tamago.aca.bank.DepositACAContainer
{
    ...
    */
    ...
    public void check(int clid, int cid, tamago.ext.aca2.ACA aca) throws tamago.TamagoException{
        ...
        // Environment of Precondition
        // Precondition test
        boolean __tamago_var_perco_13 = (("alphonse".equals(aca.user) || "boris".equals(aca.user) || "catherine".equals(aca.user) || "damien".equals(aca.user) || "elise".equals(aca.user) || "franck".equals(aca.user)) && ("customer".equals(aca.role) || "clerk".equals(aca.role) || "banker".equals(aca.role) || "director".equals(aca.role)) && ("montreal".equals(aca.org) || "toronto".equals(aca.org)));
        if(!__tamago_var_perco_13) {
            java.util.ArrayList __tamago_var_perco_12 = new java.util.ArrayList();
            if(!__tamago_var_perco_13) {
                __tamago_var_perco_12.add(new tamago.ext.tamagocc.TamagoCCFailItem("((((aca.user == \"alphonse\") or (aca.user == \"boris\") or (aca.user == \"catherine\") or (aca.user == \"damien\") or (aca.user == \"elise\") or (aca.user == \"franck\")) and ((aca.role == \"customer\") or (aca.role == \"clerk\") or (aca.role == \"banker\") or (aca.role == \"director\")) and ((aca.org == \"montreal\") or (aca.org == \"toronto\"))))"));
            }
    ...
    public void cancel(int clid, int cid, tamago.ext.aca2.ACA aca) throws tamago.TamagoException{
        ...
        // Environment of Precondition
        // Precondition test
        boolean __tamago_var_perco_17 = ("banker".equals(aca.role) && "director".equals(aca.role) && !"elisa".equals(aca.user) && !"customer".equals(aca.role) && (("alphonse".equals(aca.user) || "boris".equals(aca.user) || "catherine".equals(aca.user) || "damien".equals(aca.user) || "elise".equals(aca.user) || "franck".equals(aca.user)) && ("customer".equals(aca.role) || "clerk".equals(aca.role) || "banker".equals(aca.role) || "director".equals(aca.role)) && ("montreal".equals(aca.org) || "toronto".equals(aca.org))));
        if(!__tamago_var_perco_17) {
            java.util.ArrayList __tamago_var_perco_16 = new java.util.ArrayList();
            if(!__tamago_var_perco_17) {
                __tamago_var_perco_16.add(new tamago.ext.tamagocc.TamagoCCFailItem("(((aca.role == \"banker\")) and ((aca.role == \"director\")) and ((aca.user != \"elisa\")) and ((aca.role != \"customer\")) and (((aca.user == \"alphonse\") or (aca.user == \"boris\") or (aca.user == \"catherine\") or (aca.user == \"damien\") or (aca.user == \"elise\") or (aca.user == \"franck\")) and ((aca.role == \"customer\") or (aca.role == \"clerk\") or (aca.role == \"banker\") or (aca.role == \"director\")) and ((aca.org == \"montreal\") or (aca.org == \"toronto\"))))"));
            }
    ...
    public void deposit(int clid, int cid, tamago.ext.aca2.ACA aca) throws tamago.TamagoException{
        ...
        // Environment of Precondition
        // Precondition test
        boolean __tamago_var_perco_21 = ("clerk".equals(aca.role) && "banker".equals(aca.role) && !"customer".equals(aca.role) && (("alphonse".equals(aca.user) || "boris".equals(aca.user) || "catherine".equals(aca.user) || "damien".equals(aca.user) || "elise".equals(aca.user) || "franck".equals(aca.user)) && ("customer".equals(aca.role) || "clerk".equals(aca.role) || "banker".equals(aca.role) || "director".equals(aca.role)) && ("montreal".equals(aca.org) || "toronto".equals(aca.org))));
        if(!__tamago_var_perco_21) {
            java.util.ArrayList __tamago_var_perco_20 = new java.util.ArrayList();
            if(!__tamago_var_perco_21) {
                __tamago_var_perco_20.add(new tamago.ext.tamagocc.TamagoCCFailItem("(((aca.role == \"clerk\")) and ((aca.role == \"banker\")) and ((aca.role != \"customer\")) and (((aca.user == \"alphonse\") or (aca.user == \"boris\") or (aca.user == \"catherine\") or (aca.user == \"damien\") or (aca.user == \"elise\") or (aca.user == \"franck\")) and ((aca.role == \"customer\") or (aca.role == \"clerk\") or (aca.role == \"banker\") or (aca.role == \"director\")) and ((aca.org == \"montreal\") or (aca.org == \"toronto\"))))"));
            }
