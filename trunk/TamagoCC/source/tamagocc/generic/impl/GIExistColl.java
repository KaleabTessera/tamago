 ...
 *
 */
public class GIExistColl extends GIQuantifier implements GExistColl {

	private GExpression collection;

	public GIExistColl(GType t, GVariable v, GExpression collection, GExpression body) {
		super(t, v, body);
		this.collection = collection;
	}

	/**
	 * @see tamagocc.generic.api.GExistColl#getCollection()
	 */
	...
	public GQuantifierType getQuantifierType() {
		return GQuantifierType.EXISTCOLL;
	}
