...
/**
 * This generator is dedicated for component container.
 * It generates all functionality and contract for code verification.
 * @author Hakim Belhaouari
 */
public class TamagoCCGeneratorComponentContainer extends TamagoCCGeneratorCommon implements TamagoCCGVisitor {
	
	/** Selected percolation pattern for this container */
	protected TamagoCCPercolation percolation;
		...
		throws TamagoCCException
	{
		...
		ast.setName(owner.getBuilder().generateContainerImplementationName(entity,percolator));
	...
	public Object visitMethod(GMethod method) throws TamagoCCException {
		...
		// precondition
		percolation.fulfillEffPre(method, body, cscope);
		...
		// debut de la post condition
		percolation.fulfillEffPost(method, body, cscope);
		
		//percolation.genEffPost(method,body);
