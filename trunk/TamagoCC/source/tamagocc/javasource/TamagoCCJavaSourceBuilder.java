 ...
 *
 */
public class TamagoCCJavaSourceBuilder extends TamagoCCGeneratorTargetLanguageBuilder {

	/**
	 * 
	 */
	public TamagoCCJavaSourceBuilder() {
		super();
	}
	...
	public static Class<?> getSimpleType(String self, AExpression expr) {
		try {
			...
			case AExpression.READ: {
				...
				Method meth = c.getMethod(TamagoCCJavaSource.propertyToMethod(read.getName()),null);
