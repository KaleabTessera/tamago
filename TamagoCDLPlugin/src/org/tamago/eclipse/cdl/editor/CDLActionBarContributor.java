...
public class CDLActionBarContributor extends EditorActionBarContributor {
	...
	public void contributeToMenu(IMenuManager menuManager) {
        ...
        submenuManager.add(new Separator());
        submenuManager.add(new CDLGenericAction("Génération de Test","Génère des fichiers de test JUnit éprouvant le contrat fonctionnel sélectionné",new TamagoCompileTest()));
        
        //submenuManager.add(new Separator());
        //submenuManager.add(new CDLGenericAction("GÃ©nÃ©ration de testcase","GÃ©nÃ¨re un fichier de test avec les dernieres informations enregistre",new TamagoTestActionGen()));
